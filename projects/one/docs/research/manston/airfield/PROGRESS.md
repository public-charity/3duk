...
- Existing source supplement has 1 runway centreline, 24 taxiway records, 23 apron records and an aerodrome boundary (49 total; verify counts in generator).
...
- Reviewed Esri World Imagery in the browser, in EPSG:27700 at that extent. The imagery shows the broad surviving paved runway strip, parallel taxiways, northern dispersal pads, aprons and an isolated northeastern training strip. The image capture date is not established. Do not treat cloud shadows or grass discoloration as measured archaeological structures.
