...
Thanet bin (see tools/props/README.md and data/provenance/litterbin.json), then snapped
to the manufacturer's published size: 1158 x 598 x 553 mm.

Output -> unity/VirtualMargate/Assets/_Project/Art/Props/LitterBin/
...
OUT_DIR = os.path.join(REPO, "unity", "VirtualMargate", "Assets", "_Project", "Art", "Props", "LitterBin")
